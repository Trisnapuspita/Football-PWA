...
function getAllStandings() {
  ...
  function showAllStandings(data) {
    let standings = "";
          data.standings[0].table.forEach(function (standing) {
            standings += `
              ...
              standing.team.name
            }" height="120px" style="margin-top: 30px; width: auto; "/>
                          </div>
                          <div class="card-content">
                              <ul class="collection with-header">
                                  <li class="collection-header truncate" style="text-align: center; background-color: #f3c623; color: #127681; font-weight: bold;">${
                                    standing.team.name
                                  }</li>
                                  <li class="collection-item" style="background-color: #f3c623; color: #127681; padding-left: 20px">Won: ${
                                    standing.won
                                  }</li>
                                  <li class="collection-item" style="background-color: #f3c623; color: #127681; padding-left: 20px">Lost: ${
                                    standing.lost
                                  }</li>
                                  <li class="collection-item" style="background-color: #f3c623; color: #127681; padding-left: 20px">Draw: ${
                                    standing.draw
                                  }</li>
                                  <li class="collection-item" style="background-color: #f3c623; color: #127681; padding-left: 20px">Points: ${
                                    standing.points
                                  }</li>
                              </ul>
                          </div>
...
function getTeamById() {
  return new Promise(function (resolve, reject) {
    ...
    function showTeam(team, resolve) {
      let teamHTML = "";
      ...
      teamElement.innerHTML = `
        ...
        team.name
      }" height="200px" style="margin-top: 20px; width: auto;" />
                </div>
                <div class="card-content">
  ...
  getAll().then(function (teams) {
    ...
    teams.forEach(function (team) {
      teamHTML += `
        ...
        team.name
      }" width="100%" height="120px" style="margin-top: 10px; width: auto;">
              </a>
                <ul class="collection with-header">
                  <li class="collection-header truncate" style="background-color: #f3c623; color: #127681; font-weight: bold;">${
                    team.name
                  }</li>
                  <li class="collection-item" style="background-color: #f3c623;">
                    <a onclick="deleteFav(${
                      team.id
                    })" class="btn btn-small red" style="text-transform: capitalize">Delete From Favorite</a>
                  </li>
                </ul>
            </div>
        </div>`;
...
function getFavoriteTeamById() {
  ...
  getById(idParam).then(function (team) {
    ...
    teamElement.innerHTML = `
      ...
      team.name
    }" height="200px" style="margin-top: 20px" />
              </div>
              <div class="card-content">
                  <a class="ct">${team.name}</a>
                  <p class="here">
